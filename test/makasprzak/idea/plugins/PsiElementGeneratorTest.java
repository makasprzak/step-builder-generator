...
public class PsiElementGeneratorTest {
    private final PsiPojo testPsiPojo = PsiPojo.Builder.psiPojo()
    ...
    private PsiField mockPsiField;

    @InjectMocks private PsiElementGenerator psiElementGenerator;

    @Test
    public void shouldGenerateInterfaceName() throws Exception {
        given(mockPsiField.getName()).willReturn("someField");
        assertThat(psiElementGenerator.interfaceName(mockPsiField)).isEqualTo("SomeFieldStep");
    ...
    public void shouldGenerateInterfaceDefinition() throws Exception {
        given(mockPsiField.getName()).willReturn("someField");
        given(mockPsiField.getType().getPresentableText()).willReturn("String");
        assertThat(psiElementGenerator.interfaceDefinition(mockPsiField,"OtherFieldStep")).isEqualTo(
    ...
    public void shouldGenerateBuilderMethod() throws Exception {
        given(mockPsiField.getName()).willReturn("someField");
        given(mockPsiField.getType().getPresentableText()).willReturn("String");
        assertThat(psiElementGenerator.builderMethod(mockPsiField, "OtherFieldStep")).isEqualTo(
                "@Override\n" +
    ...
    public void shouldGenerateInjectionStatement() throws Exception {
        given(mockPsiField.getName()).willReturn("someField");
        assertThat(psiElementGenerator.setterInjection(mockPsiField, psiClass(
                "PojoClass",
    ...
    public void shouldGenerateBuilderClass() throws Exception {
        assertThat(psiElementGenerator.builderClass(testPsiPojo)
        ).isEqualTo(
    ...
    public void shouldGenerateBuilderConstructor() throws Exception {
        assertThat(psiElementGenerator.builderConstructor()).isEqualTo(
                "private Builder() {}"
        );
    }
    @Test
    public void shouldGenerateBuilderFactoryMethod() throws Exception {
        assertThat(psiElementGenerator.builderFactoryMethod(psiClass("PojoClass"), psiField("firstField"))).isEqualTo(
    ...
    public void shouldGenerateBuildMethod() throws Exception {
        assertThat(psiElementGenerator.buildMethod(
                psiClass(
                        "PojoClass",
                        psiMethod("void", "setName", "String"),
                        psiMethod("void", "setLastName", "String"),
    ...
    public void shouldGenerateBuildInterface() throws Exception {
        assertThat(psiElementGenerator.buildStepInterface(psiClass("PojoClass"))).isEqualTo(
